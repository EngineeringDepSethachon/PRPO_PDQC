...
function seedMasterData(ss) {
  ...
  if (prodSheet && prodSheet.getLastRow() === 1) {
    const prods = [
      ...
      ['PROD-QC-001', 'QC-CHM-001', 'Ethanol 99.9% AR Grade (2.5L)', 'QC', 'ขวด (2.5L)', 'ลิตร', 2.5, 850, 15, 10, 4, '', 'LOC-QC-001', 'ตู้เก็บสารเคมีทดสอบ (Lab 1)', new Date()],
      ['PROD-QC-002', 'QC-MED-PCA', 'Plate Count Agar (PCA) 500g', 'QC', 'กระปุก', 'กรัม', 500, 2400, 1500, 1000, 5, '', 'LOC-QC-002', 'ชั้นวางอาหารเลี้ยงเชื้อ (Media Shelf B)', new Date()]
    ];
